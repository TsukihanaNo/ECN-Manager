...
cursor.execute('CREATE TABLE DOCUMENT(DOC_ID TEXT, DOC_TYPE TEXT, DOC_TITLE TEXT, DEPARTMENT TEXT, DOC_REASON TEXT, REQUESTOR TEXT, AUTHOR TEXT, STATUS TEXT, COMP_DATE TEXT, COMP_DAYS NUMBER , ECN_SUMMARY TEXT, LAST_MODIFIED TEXT, STAGE NUMBER, TEMPSTAGE NUMBER, FIRST_RELEASE TEXT, RELEASE_ELAPSE NUMBER, LAST_NOTIFIED TEXT, DUE_DATE TEXT)')
