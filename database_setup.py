...
cursor.execute('CREATE TABLE ECN(ECN_ID TEXT, ECN_TYPE TEXT, ECN_TITLE TEXT, DEPARTMENT TEXT, ECN_REASON TEXT, REQUESTOR TEXT, AUTHOR TEXT, STATUS TEXT, RELEASE_DATE DATE, COMP_DATE DATE, DAYS_ELAPSED NUMBER, ECN_SUMMARY TEXT, LAST_MODIFIED DATE, STAGE NUMBER, TEMPSTAGE NUMBER)')
cursor.execute('CREATE TABLE COMMENTS(ECN_ID TEXT, NAME TEXT, USER TEXT, COMM_DATE DATE, COMMENT TEXT, TYPE TEXT)')
cursor.execute('CREATE TABLE PARTS(ECN_ID TEXT, PART_ID TEXT, DESC TEXT, DISPOSITION TEXT, REVISION TEXT)')
...
cursor.execute('CREATE TABLE USER(USER_ID TEXT, PASSWORD TEXT, NAME TEXT, ROLE TEXT, JOB_TITLE TEXT, DEPT TEXT, STATUS TEXT, EMAIL TEXT, STAGE NUMBER)')
