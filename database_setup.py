...
cursor.execute('INSERT INTO USER(USER_ID, PASSWORD, NAME, ROLE, JOB_TITLE, STATUS, DEPT, EMAIL) VALUES(?,?,?,?,?,?,?,?)',('plannerL','pass','Planner Lighting','Signer','Planner','Active','Lighting','something@e.com'))
