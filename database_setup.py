...
cursor.execute('CREATE TABLE ECN(ECN_ID TEXT, ECN_TYPE TEXT, ECN_TITLE TEXT, DEPARTMENT TEXT, ECN_REASON TEXT, REQUESTOR TEXT, AUTHOR TEXT, STATUS TEXT, COMP_DATE DATETIME, COMP_DAYS NUMBER , ECN_SUMMARY TEXT, LAST_MODIFIED DATETIME, STAGE NUMBER, TEMPSTAGE NUMBER, FIRST_RELEASE DATETIME, RELEASE_ELAPSE NUMBER, LAST_NOTIFIED DATETIME, DUE_DATE DATETIME)')
...
cursor.execute('CREATE TABLE SIGNATURE(ECN_ID TEXT, NAME TEXT, USER_ID TEXT, JOB_TITLE TEXT, SIGNED_DATE DATETIME,TYPE TEXT)')
